...
//import org.wso2.carbon.analytics.auth.rest.api.jwt.JWTInMemoryTokenStore;
//import org.wso2.carbon.analytics.auth.rest.api.jwt.JWTTokenInfoDTO;
...
@Component(
        service = JWTAuthenticationInterceptor.class,
        immediate = true
)
            ...
            if (headerPostfix != null) {
                if (headerPrefix.equalsIgnoreCase(InterceptorConstants.BEARER_PREFIX)) {
                    ...
                    if (username != null) {
                        ...
                        request.setProperty(InterceptorConstants.ACCESS_TOKEN, accessToken);
                        return true;
                    }
                    return false;
