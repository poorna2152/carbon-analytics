package org.wso2.carbon.si.metrics.prometheus.reporter.util;/*
...
public class HttpUtils {
    ...
    public static CloseableHttpResponse doGet(String accessToken, String url, Map<String, String> params) {
        ...
        try {
            ...
            String authHeader = "Bearer " + accessToken;
            httpGet.setHeader("Accept", HEADER_VALUE_APPLICATION_JSON);
            httpGet.setHeader("Authorization", authHeader);
            return doGet(httpGet);
    ...
    public static CloseableHttpResponse doPost(String accessToken, String url, JsonObject payload) {
        ...
        try {
            ...
            throw new RuntimeException("Error occurred while creating http post request.", e);
        }
    }
    ...
    public static CloseableHttpResponse doPost(String url, Map<String, String> params) {
        ...
        httpPost.setHeader("Content-type", APPLICATION_X_WWW_FORM_URLENCODED);
        try {
            StringEntity entity = new StringEntity(payload.toString());
            httpPost.setEntity(entity);
            return doPost(httpPost);
    ...
    public static CloseableHttpResponse doPatch(String accessToken, String url, JsonObject payload) {
        ...
        String authHeader = "Bearer " + accessToken;
        httpPatch.setHeader("Accept", HEADER_VALUE_APPLICATION_JSON);
        httpPatch.setHeader("Content-Type", HEADER_VALUE_APPLICATION_JSON);
    ...
    public static CloseableHttpResponse doPut(String accessToken, String url) {
        ...
        String authHeader = "Bearer " + accessToken;
        httpPut.setHeader("Accept", HEADER_VALUE_APPLICATION_JSON);
        httpPut.setHeader("Content-Type", HEADER_VALUE_APPLICATION_JSON);
    ...
    public static CloseableHttpResponse doDelete(String accessToken, String url) {
        ...
        httpDelete.setHeader("Accept", HEADER_VALUE_APPLICATION_JSON);
    ...
    private static CloseableHttpResponse doPost(HttpPost httpPost) {
        ...
        try {
            ...
            throw new RuntimeException("Error occurred while sending http post request.", e);
        }
    }
    ...
    private static CloseableHttpResponse doPatch(HttpPatch httpPatch) {
        ...
        try {
            ...
            throw new RuntimeException("Error occurred while sending http patch request.", e);
        }
    }
    ...
    private static CloseableHttpResponse doDelete(HttpDelete httpDelete) {
        ...
        try {
            ...
            throw new RuntimeException("Error occurred while sending delete http request.", e);
        }
    }
    ...
    private static CloseableHttpClient getHttpClient() {
        ...
        if (httpClientInstance == null) {
            ...
            try {
                ...
                throw new RuntimeException("Error occurred while creating http client.", e);
            } finally {
                lock.unlock();
            }
        }
